    ...
    <div className="w-full h-full flex flex-col pt-[66px] md:pt-[80px] bg-orange-50/20">
      <section className="flex overflow-hidden relative flex-col-reverse md:flex-row h-[90vh] md:h-[85vh] px-10 md:px-[130px] items-center justify-center md:justify-between gap-5 homepage">
        <div className=" text-black flex flex-col gap-9 md:gap-12 items-center justify-center md:items-start text-center">
          ...
          <Link
            to="/services"
            className="text-base font-medium text-white bg-blue-400 rounded-md px-7 md:px-12 py-4  hover:bg-blue-600 flex items-center justify-center gap-3"
          >
            Explore Services
          </Link>
        </div>
        ...
        <div className='my-[110px] px-[20px] md:px-[50px] lg:px-[20px] xl:px-[100px] flex flex-col-reverse lg:flex-row gap-[77px]' id="services">
          ...
          <div className='flex justify-center'>
            <div className="w-[337px] h-[371px] md:w-[525px] md:h-[525px] lg:w-[500px] lg:h-[600px] xl:w-[525px] xl:h-[625px] relative">
              <img src="https://images.pexels.com/photos/699459/pexels-photo-699459.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Red Triangle" />
            </div>
          </div>
        </div>
      </section>

      <section className="py-[50px]  bg-blue-400/30 ">
