...
const Navbar = () => {
  ...
  return (
    <nav
      id="navbar"
      className={`px-[40px] md:px-[130px] z-40 py-[18px] border-b border-orange-900/10 flex items-center justify-between w-full top-[0px] left-0 fixed bg-white`}
    >
      <Link
        to="/"
      ...
      <div
        className={`pb-[5px] transition duration-300 ease-in-out ${navbarVisible ? "top-[66px]" : "-top-[300px]"
          } shadow-2xl shadow-orange-900/20 flex flex-col items-center justify-between w-full left-0 absolute bg-white px-10 md:hidden`}
      >
        <Link
          to="/services"
